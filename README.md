...
- 「クエスト」画面でおすすめクエスト、または「フリー」を選ぶとタイマー画面に進みます。
- タイマー終了後は「成果を写真にとる」から成果スキャン画面を開き、Google Driveフォルダや写真/PDF、メモを登録できます。
- 成果カードを保存するとXP/コイン/学習ログに反映され、「解説を聞く」からリーフェルGPTへ移動できます。
